				...
				<div className="isolate text-white mx-auto grid max-w-md grid-cols-1 gap-10 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:gap-[100px]">
					<div className="ring-1 ring-gray-200 rounded-3xl p-8 xl:p-10">
						...
						<Link
							...
							className="ring-1 ring-inset ring-white hover:ring-white mt-6 block rounded-md py-2 px-3 text-center text-base font-medium leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b69e57] hover:outline-[#b69e57] hover:outline-offset-2 hover:outline-2 hover:outline"
							target="_blank"
						>
							Subscribe Now
						</Link>
					...
					<div className="ring-2 ring-[#b69e57] rounded-3xl p-8 xl:p-10">
						...
						<Link
							href=""
							aria-describedby="tier-standard"
							className="bg-white text-[#815316] mt-6 block rounded-md py-2 px-3 text-center text-base font-medium leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#b69e57] hover:outline-[#b69e57] hover:outline-offset-2 hover:outline-2 hover:outline"
							target="_blank"
						>
							Subscribe Now
						</Link>
